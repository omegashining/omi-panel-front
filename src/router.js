...
export const routes = [
  ...
  {
    path: '/medic',
    Component: lazy(() => import('pages/medic')),
    exact: true,
    roles: ['medic']
  },
  {
  ...
  {
    path: '/order/register/:folio',
    Component: lazy(() => import('pages/orders/register')),
    exact: false,
    roles: ['user']
  },
  {
    path: '/order/:orderId/lifestyleForm',
    Component: lazy(() => import('pages/forms/lifestyle')),
    exact: false,
    roles: ['user']
  },
  {
    path: '/order/:orderId/hormonalGeneralForm/:previous',
    Component: lazy(() => import('pages/forms/hormonal-general')),
    exact: false,
    roles: ['user']
  },
  {
    path: '/order/:orderId/hormonalGeneralForm',
    Component: lazy(() => import('pages/forms/hormonal-general')),
    exact: false,
    roles: ['user']
  },
  {
    path: '/order/:orderId/vitaminD3Form',
    Component: lazy(() => import('pages/forms/hormonal-vitamin-d3')),
    exact: false,
    roles: ['user']
  },
  {
  ...
  {
    path: '/forms/package-delivery',
    Component: lazy(() => import('pages/forms/package-delivery')),
    exact: true,
    roles: ['user']
  },
  {
    path: '/digital-file/:tab',
    Component: lazy(() => import('pages/digital-file')),
    exact: false,
    roles: ['user']
  },
  {
    path: '/forms/finish',
    Component: lazy(() => import('pages/forms/finish')),
    exact: true,
    roles: ['user']
  },
  {
  ...
  {
    path: '/auth/change-password/:code',
  ...
  {
    path: '/auth/medic/:code',
    Component: lazy(() => import('pages/auth/register/medic')),
    exact: false,
  },
  {
...
const Router = ({ user, history, routerAnimation }) => {

  const redirect = () => {
    if( user.role === 'admin' ) return <Redirect to="/admin" />;
    if( user.role === 'medic' ) return <Redirect to="/medic" />;
    return <Redirect to="/digital-file/orders" />;
  }
  return (
